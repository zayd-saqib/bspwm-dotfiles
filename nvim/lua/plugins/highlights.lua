...
vim.api.nvim_set_hl(0, '@string', { fg = '#92c97e' }) -- #96d480
vim.api.nvim_set_hl(0, 'String', { fg = '#92c97e' })
...
vim.api.nvim_set_hl(0, '@property', { fg = '#a5a7d1' })
...
vim.api.nvim_set_hl(0, 'Comment', { fg = '#362e50' }) -- set the color for comments
vim.api.nvim_set_hl(0, 'NonText', { fg = '#1d1a2b' }) -- set the color for empty lines
vim.api.nvim_set_hl(0, 'LineNr', { fg = '#261f36' }) -- set the color for line numbers
